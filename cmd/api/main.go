...
func main() {
	...
	// TODO: Delete next line and uncomment next
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres@localhost/greenlight2?sslmode=disable", "PostgreSQL DSN")
	// flag.StringVar(&cfg.db.dsn, "db-dsn", "", "PostgreSQL DSN")

	// Add env to .profile: export GREENLIGHT_DB_DSN='postgres://greenlight:pa55word@localhost/greenlight?sslmode=disable'
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "123", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "456", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.iskhakov.net>", "SMTP sender")
